...
export default Vue.extend({
  ...
  methods: {
    ...
    async mintPad() {
      const tx = await this.farmContract.populateTransaction.mintPad()
      await this.safeSendTransaction({ tx, targetChainId: this.ecosystem.chainId})
    },
    async payVault() {
      const tx = await this.farmContract.populateTransaction.payVault()
      await this.safeSendTransaction({ tx, targetChainId: this.ecosystem.chainId})
    },
    async harvest() {
      let tx
