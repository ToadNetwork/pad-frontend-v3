  ...
  <v-container class="main-container">
    ...
    <div class="launchpad-faq">
      ...
      <v-expansion-panel-content>
        ...
        <ul class="perks-list">
          <li>
            Your presale must have a hard cap (maximum total contribution) of <b>at least<b> $100K. While reaching the hard cap is not required, failing to reach the <b>soft cap</b> (25% of hard cap) results in the presale being automatically cancelled.
          </li>
          <li>
    ...
    <div class="text-center" style="margin:20px">
      If your presale meets the criteria above, email us at <a href="mailto:snake@toad.network" target="blank" style="color: #00f000">snake@toad.network</a> or message us on <a href="https://t.me/toadnetwork" target="blank" style="color: #00f000">Telegram</a>
