  ...
  <v-container class="main-container">
    ...
    <div class="launchpad-faq">
      ...
      <v-expansion-panel-content>
        ...
        <ul class="perks-list">
          <li>
            Your presale must have a hard cap of at least $200K worth of tokens.
          </li>
          <li>
            At least 50% of your token's supply must be allocated to the presale, unless there's a good reason to do otherwise or your tokenomics don't allow it.
          </li>
          <li>
